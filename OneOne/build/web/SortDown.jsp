                                    ...
                                    <li class="nav-item submenu dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item activeS">
                                                <a class="nav-link active" href="ControllerSort?do=Sort_Min_to_Max">Min -> Max</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
...
<!--                                        <a href="#" class="icons" onclick="if (document.getElementById('search').style.display == 'none') {
  ...
  <ul class="pagination">
    ...
    <li class="page-item <%=pagePro==i?"active":""%>"><a class="page-link" href="ControllerSort?do=PageProductSort_MintoMax&page=<%=i%>"><%=i%></a>
    </li>
    <%}%>   
  </ul>
</div>

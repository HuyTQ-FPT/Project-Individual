                ...
                <tbody>
                    ...
                    <tr class="name">
                        ...
                        <td style="width:100px;">
                            ...
                            <a href="ControllerProduct?do=updateProduct&pid=<%=pro.getProductID()%>" class="edit" title="Update" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="ControllerProduct?do=deleteProduct&pid=<%=pro.getProductID()%>" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                        </td>                        
                    </tr> 
                    <%}%>
                </tbody>

        ...
        <div class="row s_product_inner">
            ...
            <div class="s_product_img">
              ...
              >
                <ol class="carousel-indicators">
                  ...
                  >
                    <img
                      src="<%=rs.getString(11).replace("1.jpg", "2.jpg")%>"
                      alt=""
                    />
                  </li>
                  <li
                  ...
                  >
                    <img
                      src="<%=rs.getString(11).replace("1.jpg", "3.jpg")%>"
                      alt=""
                    />
                  </li>
                </ol>
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img
                      class="d-block w-100" style="height:520px;overflow: hidden;"
                      src="<%=rs.getString(11)%>"
                      alt="First slide"
                    />
                  </div>
          ...
          <div class="col-lg-5 offset-lg-1">
            <div class="s_product_text">
              ...
              <h2>$<%=rs.getDouble(6)%></h2>
              <ul class="list">
                <li>
                  <a class="active" href="#">
                    <span>Category</span> : <%=rs.getString(12)%></a
                  >
                </li>
                <li>
                  <a href="#"> <span>Availibility</span> : <%=rs.getString(13)%></a>
                </li>
              </ul>
              <p>
              ...
              <div class="card_area">
                <a class="main_btn" href="ControllerDetailProduct?do=AddtoCart&pid=<%=rs.getString(1)%>">Add to Cart</a>
              </div>
            </div>
          </div>
              <%}%>

                            ...
                            <div class="col-lg-7 pr-0">
                                <ul class="nav navbar-nav center_nav pull-right">
                                    <li class="nav-item active">
                                        <a class="nav-link" href="ConrollerAddtoCart?do=listAllProduct">Home</a>
                                    </li>
                                    ...
                                    <li class="nav-item submenu dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="nav-item">
                                                <a class="nav-link activeS" href="ControllerAddtoCart?do=listAllProduct">Normal</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="ControllerSort?do=Sort_Max_to_Min">Max -> Min</a>
                                            </li>
                                            <li class="nav-item">
...
<!--                                        <a href="#" class="icons" onclick="if (document.getElementById('search').style.display == 'none') {
            ...
            <div class="container">
                <div class="banner_content row">
                    <div class="col-lg-12">
                        ...
                        <h3><span>Show</span> Your <br />Fashion <span>Style</span></h3>
        ...
        <div class="container">
            <div class="row">
                <%  int pagePro=(int)Integer.parseInt(request.getAttribute("page").toString());
                    if(vector.size()>size_page && vector.size()<3*size_page){
                    for (int i = 0; i < vector.size()-13; i++) {%>
    ...
    <section class="new_product_area section_gap_top section_gap_bottom_custom">
        <div class="container">
            <div class="row">
                <% for (int i = vector.size()-13; i <= vector.size()-13; i++) {%>
                <div class="col-lg-6">
                    <div class="new_product">
                        <h5 class="text-uppercase">collection of 2022</h5>                      
                        <div class="product-img">
                            <img class="img-fluid w-75" style="height:310px;overflow: hidden;" src="<%=vector.get(i).getimage()%>" alt="" />
                        </div>
                ...
                <div class="col-lg-6 mt-5 mt-lg-0">
                    <div class="row">
                        <% for (int i = vector.size()-12; i <= vector.size()-9; i++) {%>
    ...
    <section class="inspired_product_area section_gap_bottom_custom">
        <div class="container">
            <div class="row">
                <% for (int i = vector.size()-8; i < vector.size(); i++) {%>
                <div class="col-lg-3 col-md-6">
                    <div class="single-product">
                        <div class="product-img">
                            <img class="img-fluid w-100" style="height:255px;overflow: hidden;" src="<%=vector.get(i).getimage()%>" alt="" />
                ...
                <%}%>                
                 ...
                 <%}else if(vector.size()>size_page-1){
                    for (int i = 0; i < vector.size()-13; i++) {%>
                <div class="col-lg-3 col-md-6">  
                    <div class="single-product">
                        <div class="product-img">
  ...
  <ul class="pagination">
    ...
    <li class="page-item <%=pagePro==i?"active":""%>"><a class="page-link" href="ControllerAddtoCart?do=PageProduct&page=<%=i%>"><%=i%></a>
    </li>
    <%}%>   
  </ul>
</div>
                    ...
                    <div class="single-product">
                        <div class="product-img">
                            ...
                            <div class="p_icon">
                                ...
                                <a href="ControllerAddtoCart?do=AddtoCart&pid=<%=vector.get(i).getProductID()%>&pname=<%= vector.get(i).getProductName()%>&price=<%=vector.get(i).getUnitPrice()%>&quantity=<%=vector.get(i).getUnitsInStock()%>">
                                    <i class="ti-shopping-cart"></i>
                                </a>             
                            </div>
                        </div>
